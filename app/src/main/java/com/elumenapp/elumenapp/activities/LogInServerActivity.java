...
public class LogInServerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebookButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(LogInServerActivity.this, RegisterServerActivity.class));
                finish();
            }
        });
    ...
    public void logInButtonListener(View view) {
        ...
        if (!MainActivityOld.connecting) {
            ...
            MySingleton.getInstance(LogInServerActivity.this).addToRequestQueue(stringRequest);
        }
    }
