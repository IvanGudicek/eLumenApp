...
public class MainActivityOld extends AppCompatActivity
    ...
    public static void setListOfPersons(List<Person> listOfPersons) {
        MainActivityOld.listOfPersons = listOfPersons;
    }
    ...
    public class ThreadServerPerson implements Runnable {
        ...
        public void run() {
            ...
            MySingleton.getInstance(MainActivityOld.this).addToRequestQueue(stringRequest);
        }
    }
    ...
    public static void getConnectionInfo(Context context) {
        ...
        MainActivityOld.connecting = !(networkInfo == null || !networkInfo.isConnected());
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // AppEventsLogger.activateApp(this);
        ...
        getConnectionInfo(MainActivityOld.this);
    ...
    public void startQuizButtonListener(View view) {
        if (connecting && !server_error && (logging || sharedPreferences && !logouting)) {
            startActivity(new Intent(MainActivityOld.this, StartQuizActivity.class));
            finish();
        } else {
            Toast.makeText(MainActivityOld.this, "You are not log in!!!", Toast.LENGTH_LONG).show();
        }
    }

    public void profileButtonListener(View view) {
        startActivity(new Intent(MainActivityOld.this, PersonActivity.class));
    }

    public void signUpButtonListener(View view) {
        startActivity(new Intent(MainActivityOld.this, LogInServerActivity.class));
        finish();
    }
    ...
    public void listOfPersonsButtonListener(View view) {
        getConnectionInfo(MainActivityOld.this);
        if (server_error) {
            Toast.makeText(MainActivityOld.this, "Something went wrong on the server...", Toast.LENGTH_LONG).show();
            Toast.makeText(MainActivityOld.this, "through few seconds will be enabled question for all users :)", Toast.LENGTH_LONG).show();
        } else {
            if (connecting) {
                startActivity(new Intent(MainActivityOld.this, RecyclerActivity.class));
            } else {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_profile:
                ...
                break;
            case R.id.nav_tools:
                startActivity(new Intent(MainActivityOld.this, Settings_Activity.class));
                break;
            case R.id.nav_exit:
                exitButtonListener(globalView);
                break;
            case R.id.nav_share:
                Toast.makeText(MainActivityOld.this, "Will be soon", Toast.LENGTH_LONG).show();
                break;
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
        if (drawer != null) {
